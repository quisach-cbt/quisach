...
<svelte:head>
	<title>{user.displayName} | BTOI: Ben Tre Olympiad in Informatics</title>
	<meta name="description" content="{user.displayName}'s profile on BTOI Platform" />
</svelte:head>
		...
		<div class="w-full lg:w-1/3">
			<div class="p-6 bg-white rounded-lg shadow-md">
				<div class="flex flex-col items-center lg:items-start">
					...
					<Head2 class="mb-1 text-2xl font-bold">{user.displayName}</Head2>
