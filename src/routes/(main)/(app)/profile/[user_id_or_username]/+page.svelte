...
<div class="bg-white rounded-lg shadow-md p-6 mt-4">
	...
	<div class="text-sm text-gray-700">
		...
		></textarea>
		<div class='text-gray-500 text-xs mt-1 font-body'>
...
<div class="bg-white rounded-lg shadow-md p-6 mt-4">
	...
	<div class="contribution-wrapper">
		<h5 class="text-sm font-bold mb-2">{totalCommits} submissions in the last year</h5>
		...
		<div class="contribution-graph">
			...
			<div class="legend mt-2 flex items-center justify-end text-xs text-gray-600">
				...
				<div class="bg-gray-100 rounded-sm w-3 h-3 mr-1"></div>
				<div class="bg-green-100 rounded-sm w-3 h-3 mr-1"></div>
				<div class="bg-green-300 rounded-sm w-3 h-3 mr-1"></div>
				<div class="bg-green-500 rounded-sm w-3 h-3 mr-1"></div>
				<div class="bg-green-700 rounded-sm w-3 h-3 mr-1"></div>
				<span>More</span>
			</div>
		</div>
	</div>
...
<Modal
	...
	bind:isOpen={saveAboutMeModalOpen}
	size='md'
>
{#snippet children()}
	<p class="text-sm text-gray-600">
		You have exceeded the maximum character limit of 1000 characters. Please shorten your input before saving.
	</p>
{/snippet}
...
{#snippet footer()}
	<Button 
		variant="outline" 
		onclick={() => saveAboutMeModalOpen = false}
	>
		Close
	</Button>
{/snippet}
