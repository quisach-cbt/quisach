...
<svg
	class={cn('size-5 fill-current', className)}
...
>
    ...
    0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61-.546-1.387-1.333-1.756-1.333-1.756-1.09-.745.084-.729.084-.729 
    1.205.084 1.84 1.236 1.84 1.236 1.07 1.835 2.809 1.305 
    3.495.998.108-.775.418-1.305.762-1.605-2.665-.3-5.466-1.335-5.466-5.93 
    ...
    5.92.435.375.81 1.102.81 2.222 0 1.606-.015 2.896-.015 
